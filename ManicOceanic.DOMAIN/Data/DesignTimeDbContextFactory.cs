  ...
  public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<MOContext>
  {
    public MOContext CreateDbContext(string[] args)
    {
      ...
      var connectionString =
        "Server=tcp:ec-teams.database.windows.net,1433;Initial Catalog=Manic-Oceanic;" +
        "Persist Security Info=False;User ID=ecteam;Password=Ec@181818;MultipleActiveResultSets=False;" +
